$(document).ready(function(){
    ...
    $('#Download_PDF').on("click", function(){
        ...
        $('#resultContainer').print({
            ...
            iframe : true,                   
            prepend :"<div class='text-print'><div class='content-brand-print'><div class='brand-print'><img src='Assets/img/brand/Logo_Diretrix_Footer.png' class='responsive_img'></div></div><div class='mb-4'><span class='mr-1 '><i class='fas fa-exclamation-circle'></i></span> Este documento foi gerado pelo usuário <strong>" + user +"</strong> em <strong>" + date +"</strong> através da ferramenta <strong>Diretrix.On&copy;</strong> e só poderá ser utilizada para as devidas atividades de acordo com termo de aceitação de uso e termo de proteção e privacidade de dados, deixando este usuário com total responsabilidade sobre as devidas precauções de proteção, sob as penas previstas no CONTRATO e nas legislações aplicáveis.</div></div></div> ",
            append :"<div class='text-print'><div class='mb-4 mt-4'><span class='mr-1 '><i class='fas fa-exclamation-circle'></i></span> Este documento foi gerado pelo usuário <strong>" + user +"</strong> em <strong>" + date +"</strong> através da ferramenta <strong>Diretrix.On&copy;</strong> e só poderá ser utilizada para as devidas atividades de acordo com termo de aceitação de uso e termo de proteção e privacidade de dados, deixando este usuário com total responsabilidade sobre as devidas precauções de proteção, sob as penas previstas no CONTRATO e nas legislações aplicáveis.<div class='content-brand-print'><div class='brand-print'><img src='Assets/img/brand/Logo_Diretrix_Footer.png' class='responsive_img'></div></div> ",
        });
